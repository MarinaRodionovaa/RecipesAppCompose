package com.marinarodionova.recipecomposeapp.data.repository
...
object RecipesRepositoryStub {
    ...
    fun getCategoryByCategoryId(categoryId: Int): CategoryDto {
    ...
    fun getRecipesByRecipeId(recipeId: Int): RecipeDto {
